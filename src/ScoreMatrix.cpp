...
vector<unsigned char> ScoreMatrix::getBlosumAlphabet() {
    unsigned char alphabet[25] = {'A', 'R', 'N', 'D', 'C', 'Q', 'E', 'G', 'H', 'I', 'L', 'K', 
                         'M', 'F', 'P', 'S', 'T', 'W', 'Y', 'V', 'B', 'J', 'Z', 'X', '*'};
    return vector<unsigned char>(alphabet, alphabet+25);
}
...
//       A   R   N   D   C   Q   E   G   H   I   L   K   M   F   P   S   T   W   Y   V   B   J   Z   X   *
    ...
    return ScoreMatrix(ScoreMatrix::getBlosumAlphabet(), vector<int>(matrix, matrix+25*25));
}
